class Shoehorn < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shoehorn-dev/shoehorn-cli/releases/download/v0.2.2/shoehorn_darwin_arm64"
      sha256 "75d6ee616f7024bef0926af9e7e8e2195ad4c9ea3dab9b9ac9c1ec2bd64be4d4"
    else
      url "https://github.com/shoehorn-dev/shoehorn-cli/releases/download/v0.2.2/shoehorn_darwin_amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/shoehorn-dev/shoehorn-cli/releases/download/v0.2.2/shoehorn_linux_arm64"
      sha256 "c2020c4cae04a1a8f34bdc5cb3c0a409a8746d231c2848109a7d635baee44eea"
    else
      url "https://github.com/shoehorn-dev/shoehorn-cli/releases/download/v0.2.2/shoehorn_linux_amd64"
